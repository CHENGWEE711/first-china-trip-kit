...
export const products: Product[] = [
  ...
  },
  {
    ...
    summary:
      "A seven-file pre-arrival setup system with the complete $7 Payment & Apps Guide, internet planning, Chinese address tools, first-day routing and offline backups.",
    structuredDataDescription:
      "A practical seven-file PDF system for first-time visitors preparing payments, mobile data, hotel details, airport transfer, first-day actions and offline backups for China.",
    bestFor:
    ...
    includes: [
      "15 / 30 / 60-minute Read Me First routes",
      "30-page China Arrival Setup Guide",
      "Complete $7 Payment & Apps Setup Guide",
      "10 bilingual Mobile Quick Cards",
      "Fillable My China Arrival Sheet",
      "Five troubleshooting decision trees",
      "Offline checklist, sources and update log",
    ],
    price: "$19",
    status: "available",
    checkoutProvider: "payhip",
